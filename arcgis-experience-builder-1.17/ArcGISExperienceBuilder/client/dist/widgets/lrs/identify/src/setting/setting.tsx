          ...
          {(config?.lrsLayers?.length > 0) && (
            <div>
              ...
              {config?.eventLayers && (config?.eventLayers?.length > 0) && (
                <SettingSection>
                  <SettingRow flow="no-wrap" tag='label' label={this.getI18nMessage('lineAttributeToggle')}>
                    <Switch
                  ...
                  <SettingRow flow="no-wrap" tag='label' label={this.getI18nMessage('pointAttributeToggle')}>
                    <Switch
