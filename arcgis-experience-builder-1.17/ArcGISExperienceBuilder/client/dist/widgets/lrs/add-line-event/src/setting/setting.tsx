        ...
        <div className="jimu-widget-setting setting-add-line-event__setting-content h-100">
          ...
          {config.eventLayers && config.eventLayers.length !== 0 && (
            <div>
              ...
              >
                <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideType')}>
                  <Switch
                    checked={this.getHideTypeConfig()}
                    onChange={this.handleHideTypeChange}
                  />
                </SettingRow>
                <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideEvent')}>
                  <Switch
                    checked={this.getHideEventConfig()}
                    onChange={this.handleHideEventChange}
                  />
                </SettingRow>
                <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideNetwork')}>
                  <Switch
                    checked={this.getHideNetworkConfig()}
                    onChange={this.handleHideNetworkChange}
                  />
                </SettingRow>
                <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideMethod')}>
                  <Switch
                    checked={this.getHideMethodConfig()}
                    onChange={this.handleHideMethodChange}
                  />
                </SettingRow>
                <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideAttributeSet')}>
                  <Switch
                    checked={this.getHideAttributeSetConfig()}
                    onChange={this.handleHideAttributeSetChange}
                  />
                </SettingRow>
                <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideMeasures')}>
                ...
                <div style={{ display: 'none' }}>
                  <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideDates')}>
                    <Switch
                  ...
                  {config.hideDates && (
                    <SettingRow tag='label' label={formatMessage(this.props.intl, 'useRoutesStartEndDates')}>
