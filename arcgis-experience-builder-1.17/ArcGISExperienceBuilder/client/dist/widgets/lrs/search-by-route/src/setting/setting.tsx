...
import type { IMConfig, Style, NetworkItem, ResultConfig } from '../config'
          ...
          {config.networkItems.length !== 0 && (
            <div>
              ...
              >
                ...
                {supportsLines && (
                  <SettingRow tag='label' label={formatMessage(this.props.intl, 'hideRoute')}>
                    <Switch
