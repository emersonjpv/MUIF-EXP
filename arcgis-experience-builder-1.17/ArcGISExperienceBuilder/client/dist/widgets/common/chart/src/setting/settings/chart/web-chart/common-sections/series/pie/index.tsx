  ...
  <div className='pie-series-setting w-100' role='group' aria-label={translate('slices')}>
    ...
    >
      <LabelDisplaySetting
        ...
        onDisplayNumericValueChange={(checked: boolean) => { handlePropertyChange('displayNumericValueOnDataLabel', checked) }}
        onDisplayPercentageChange={(checked: boolean) => { handlePropertyChange('displayPercentageOnDataLabel', checked) }}
      />
    ...
    >
      <LabelDisplaySetting
        ...
        onDisplayNumericValueChange={(checked: boolean) => { handlePropertyChange('displayNumericValueOnTooltip', checked) }}
        onDisplayPercentageChange={(checked: boolean) => { handlePropertyChange('displayPercentageOnTooltip', checked) }}
      />
    </CollapsableToggle>
