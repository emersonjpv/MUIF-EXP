...
import { getSplitByField, SelectionSource, type WebChartDataItem, type SelectionData, type ArcgisChartCustomEvent, type SelectionCompletePayload } from 'jimu-ui/advanced/chart'
...
export const useSelection = (
  ...
  const handleSelectionChange = hooks.useEventCallback((e: ArcgisChartCustomEvent<SelectionCompletePayload>) => {
    ...
    const selectionSource = e.detail.selectionData?.selectionSource as SelectionSource
