...
export const DefaultColor = 'var(--ref-palette-neutral-1200)'
export const DefaultTextColor = 'var(--ref-palette-neutral-1200)'
export const DefaultBgColor = 'var(--ref-palette-white)'
export const DefaultLineColor = 'var(--ref-palette-neutral-700)'
...
// title
export const DefaultTitleColor = 'var(--ref-palette-black)'
export const DefaultTitleWeight = 500
export const DefaultTitleSize = 16

// footer
export const DefaultFooterSize = 12
export const DefaultFooterColor = 'var(--ref-palette-neutral-1100)'

// series
export const DefaultSeriesLabelSize = 10
export const DefaultValueLabelColor = 'var(--ref-palette-neutral-1000)'

// axes
export const DefaultAxisColor = 'var(--ref-palette-neutral-700)'
export const DefaultAxisLabelColor = 'var(--ref-palette-neutral-1000)'
export const DefaultAxisTitleColor = 'var(--ref-palette-neutral-1100)'
export const DefaultAxisTitleSize = 14
export const DefaultAxisLabelSize = 12
export const DefaultAxisScrollbarColor = 'var(--ref-palette-neutral-500)'
...
export const DefaultLegendTitleColor = 'var(--ref-palette-neutral-1100)'
export const DefaultLegendLabelColor = 'var(--ref-palette-neutral-1100)'
export const DefaultPieLegendLabelMaxWidth = 200
// grid
export const DefaultGridColor = 'var(--ref-palette-neutral-400)'
// color by slices
...
export const DefaultGaugeAxisColor = 'var(--ref-palette-neutral-500)'
export const DefaultGaugeAxisInnerLabelColor = 'var(--ref-palette-neutral-1100)'
export const DefaultGaugeNeedleColor = 'var(--sys-color-primary-main)'
export const DefaultGaugeNeedleOutlineColor = 'var(--ref-palette-neutral-700)'
...
export const DefaultSeriesOutlineColor = 'var(--ref-palette-neutral-700)'
export const DefaultPieSeriesOutlineColor = 'var(--ref-palette-neutral-200)'
...
export function getDefaultPieChartSeries (innerRadius: number = 0): WebChartSeries {
  ...
  return {
    ...
    fillSymbol: getFillSymbol(color, 1, 'var(--ref-palette-neutral-200)'),
    dataLabels: getChartText('', false, DefaultSeriesLabelSize, DefaultValueLabelColor)
  } as WebChartSeries
}
