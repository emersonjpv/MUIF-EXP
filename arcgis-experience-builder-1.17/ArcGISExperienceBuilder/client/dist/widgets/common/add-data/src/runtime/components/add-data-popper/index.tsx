/** @jsx jsx */
import { React, jsx, css, defaultMessages as jimuCoreMessages, hooks, type ImmutableArray, focusElementInKeyboardMode } from 'jimu-core'
  ...
  const handlePopperKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
    if (e.key === 'Escape') {
      ...
      if (e.target === popperCloseBtnRef.current) {
        ...
        focusElementInKeyboardMode(popperCloseBtnRef.current)
      }
    }
  }
