/** @jsx jsx */
import { React, jsx, type DataSource, type IMUseDataSource, hooks, type ImmutableArray, type UseDataSource } from 'jimu-core'
...
const EditListDataSource = (props: EditListDataSourceProps) => {
  const { useDataSources, unsavedChange, onDataSourceCreated, onSelectionChange } = props
