/** @jsx jsx */
import {
  React, jsx, Immutable, polished, css, type IMDataSourceJson, hooks, type ImmutableObject, type UseDataSource, type ImmutableArray,
  DataSourceManager
} from 'jimu-core'
...
const LayerConfig = (props: LayerConfigProps) => {
  const { layerConfig, isGeoMode, layerDefinition, layerEditingEnabled, isFromMap, filterDs, onChange, onClose } = props
