...
type LayerConfigFieldProps = Pick<LayerConfigProps, 'layerConfig' | 'onChange' | 'layerDefinition' | 'layerEditingEnabled' | 'isFromMap'>
...
const LayerConfigField = (props: LayerConfigFieldProps) => {
  const { layerConfig, layerDefinition, layerEditingEnabled, isFromMap, onChange } = props
  ...
  return isFromMap && <SettingSection title={translate('configFields')} css={getStyle(theme)}>
    <SettingRow>
