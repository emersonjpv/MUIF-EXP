/** @jsx jsx */
import { React, jsx, SupportedLayerServiceTypes, hooks, css, type IMThemeVariables } from 'jimu-core'
...
const LayerConfigCapability = (props: LayerConfigCapabilityProps) => {
  ...
  return <SettingSection title={translate('capability')} css={getStyle(theme)}>
    {layerEditingEnabled
      ? <React.Fragment>
