...
const EditWidget = (props: AllWidgetProps<IMConfig>) => {
  const { id, label, config, useDataSources, useMapWidgetIds } = props
  ...
  return isAttributeOnly
    ...
    : <EditorComponent widgetId={id} config={config} canEditFeature={canEditFeature} useMapWidgetIds={useMapWidgetIds} />
}
