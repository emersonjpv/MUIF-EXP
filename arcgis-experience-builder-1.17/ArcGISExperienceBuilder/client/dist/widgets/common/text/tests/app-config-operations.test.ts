import { getReplacedDataSource, mapExpressionForText, mapHtmlDataDsId, mapLinks, replaceExpressionDataSources, replaceLinkExpressionDataSources } from '../src/tools/app-config-operations'
...
describe('app-config-operations utils', function () {
  ...
  it('mapExpression', () => {
    ...
    let output = mapExpressionForText(html, contentMap)
    ...
    output = mapExpressionForText(html, contentMap)
  ...
  describe('mapLinks', () => {
    it('page and view', () => {
      ...
      let output = mapLinks(html, contentMap, false)
      ...
      output = mapLinks(output, contentMap, false)
    ...
    it('with expression', () => {
      ...
      const output = mapLinks(html, contentMap, true)
  ...
  it('replaceExpressionDataSources', () => {
    ...
    let output = replaceExpressionDataSources(html, replacedDataSources)
    ...
    output = replaceExpressionDataSources(html, replacedDataSources)
  ...
  it('replaceLinkExpressionDataSources', () => {
    ...
    const output = replaceLinkExpressionDataSources(html, replacedDataSources)
