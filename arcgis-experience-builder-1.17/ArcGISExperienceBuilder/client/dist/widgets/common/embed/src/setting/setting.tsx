...
> {
  ...
  render () {
    ...
    const { embedType, enableLabel, label, autoRefresh, autoInterval, honorThemeFont } = config
    ...
    const honorFontLabel =  (
      <div className='w-100 d-flex tip-container'>
        <span className='tip-text' title={this.formatMessage('honorThemeFont')}>{this.formatMessage('honorThemeFont')}</span>
