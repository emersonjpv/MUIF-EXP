...
export default class Widget extends React.PureComponent<AllWidgetProps<IMConfig> & Props, State> {
  ...
  componentDidUpdate (preProps, preStates) {
    ...
    const { embedCode, embedType, autoRefresh, autoInterval, expression, honorThemeFont } = config
    const { config: preConfig, appMode: preAppMode, sectionNavInfos: preSectionNavInfos, theme: preTheme } = preProps
    const { autoRefresh: preAutoRefresh, autoInterval: preAutoInterval, embedType: preEmbedType, honorThemeFont: preHonorThemeFont } = preConfig
