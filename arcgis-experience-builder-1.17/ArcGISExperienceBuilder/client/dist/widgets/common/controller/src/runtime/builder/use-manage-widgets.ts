...
import { getVisibleOrderFromLayout, getWidgetChildLayoutJson, useIsSelected, useWidgetChildLayoutJson } from '../common/layout-utils'
...
const useManageWidgets = (controllerId: string) => {
  ...
  }, [controllerId, isItemDroppable, isSelected, onTreeRemove, onTreeSort, widgetTreeJson])
}
