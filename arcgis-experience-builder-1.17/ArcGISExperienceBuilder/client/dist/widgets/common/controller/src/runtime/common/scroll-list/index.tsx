/** @jsx jsx */
import { React, css, jsx, classNames, hooks, getAppStore, appActions } from 'jimu-core'
...
export const ScrollList = React.forwardRef((props: ScrollListProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  React.useEffect(() => {
    if (isSelected) {
      getAppStore().dispatch(appActions.widgetStatePropChange(controllerId, 'onArrowClick', scroll))
    }
