...
export class Widget extends React.PureComponent<ListProps, ListStates> {
  ...
  listWidgetCon: React.RefObject<HTMLDivElement>
  ...
  constructor (props) {
    ...
    this.listWidgetCon = React.createRef<HTMLDivElement>()
  ...
  handleListKeyDown = (e) => {
    if (e.key === 'Escape') {
      focusElementInKeyboardMode(this.jumpOutNodeOfList)
    }
  }
  ...
  getListInnerElementType = () => {
    ...
    if (this.lastSpace !== space) {
      ...
      this.innerElementType = forwardRef(({ style, ...rest }, ref: any) => (
        <div
          ref={ref}
          style={{
            ...style,
