...
import {
  ...
  LinkType, type Expression, AllDataSourceTypes, type IconResult, type IMLinkParam
} from 'jimu-core'
...
export default class Setting extends React.PureComponent<AllWidgetSettingProps<IMConfig>, State> {
  ...
  onDataSourceChange = (useDataSources: UseDataSource[]) => {
    ...
    this.props.onSettingChange({
       ...
       */
      useDataSources: this.mergeUseDataSources(this.getTextExpression(), this.getTipExpression(), this.getLinkSettingExpression(), Immutable(useDataSources), false) as unknown as UseDataSource[]
    })
  }
