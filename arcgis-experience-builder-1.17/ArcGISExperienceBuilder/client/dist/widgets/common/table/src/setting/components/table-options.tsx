...
import { DistanceUnits, defaultMessages as jimuUIMessages, Label, Radio } from 'jimu-ui'
import { SettingRow, SettingSection } from 'jimu-ui/advanced/setting-components'
import defaultMessages from '../translations/default'
import { defaultMessages as jimuLayoutsMessages } from 'jimu-layouts/layout-runtime'
import {  ResponsiveType } from '../../config'
...
const TableOptions = (props: TableOptionsProps) => {
  ...
  const handleColumnStyleChange = React.useCallback((key: string, value: ResponsiveType | number) => {
    if (columnSetting) {
