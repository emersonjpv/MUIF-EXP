...
const TableTools = (props: TableOptionsProps) => {
  ...
  const { layerHonorMode, enableEdit, enableSelect, enableSearch, searchFields, searchExact, searchHint, selectMode, enableDelete, useDataSource } = layerConfig
