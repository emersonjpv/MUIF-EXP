  ...
  return (
    <div>
      ...
      >
        ...
        {(config.isShowRecentSearches && recentSearchesData[0]?.suggestionItem?.length > 0) && <Button role='button' className='clear-recent-search-con jimu-outline-inside' aria-label={nls('clearRecentSearches')} title={nls('clearRecentSearches')} onClick={clearSearches}>
