...
import {
  ...
  ImageDisplayQualityMode, AllDataSourceTypes, ExpressionPartType, type IMLinkParam
} from 'jimu-core'
          ...
          <SettingSection>
            ...
            {useDataSourcesEnabled && <div className='mt-4'>
              <Tabs fill type='pills' onChange={this.onTabSelect} value={this.props.config.functionConfig.imgSourceType === ImgSourceType.ByDynamicUrl ? 'dynamicSource' : 'staticSource'}>
                ...
                >
                  <div className='mt-4'>
                    {(!this.props.config.functionConfig.imgSourceType || this.props.config.functionConfig.imgSourceType !== ImgSourceType.ByDynamicUrl) && <SettingRow>
                      <div className='w-100 d-flex align-items-center'>
                        <div style={{ minWidth: '60px' }}>
                          <ImageSelector
                            buttonClassName='text-dark d-flex justify-content-center btn-browse'
