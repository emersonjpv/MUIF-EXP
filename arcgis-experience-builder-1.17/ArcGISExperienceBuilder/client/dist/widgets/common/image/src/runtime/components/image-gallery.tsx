import { type IntlShape, React, type AttachmentInfo } from 'jimu-core'
...
export class ImageGallery extends React.PureComponent<ImageGalleryProps, States> {
  ...
  render () {
    ...
    const previousString = this.props.intl.formatMessage({ id: 'previousImage', defaultMessage: defaultMessages.previousImage })
    const nextString = this.props.intl.formatMessage({ id: 'nextImage', defaultMessage: defaultMessages.nextImage })
