...
export const print = async (option: PrintOption) => {
  const { printTemplateProperties, useUtility, isSupportReport, widgetId, useMapWidgetIds, jimuMapView, reportOptions, elementOverrides, toggleUtilityErrorRemind } = option
