/** @jsx jsx */
import { React, jsx, AllDataSourceTypes, defaultMessages as jimuCoreDefaultMessage, type ImmutableArray, Immutable, hooks, type ImmutableObject, type UseDataSource } from 'jimu-core'
import { SettingSection, SettingRow } from 'jimu-ui/advanced/setting-components'
import { TextInput, Select, Option, Checkbox, CollapsablePanel, defaultMessages as jimuUiDefaultMessage } from 'jimu-ui'
...
const LayoutOptionSetting = (props: Props) => {
  ...
  const renderElementOverridesOptionsSettingItem = (elementOverridesOption, elementType: string, index: number) => {
    ...
    return (<CollapsablePanel
      label={name}
      key={`${name}_${index}`}
      isOpen={elementOverridesOptionsOpenList?.[elementType]?.[name] || false}
