...
import { TextInput, Switch, MultiSelect, AlertPopup, Loading, defaultMessages as jimuUiDefaultMessage } from 'jimu-ui'
...
const CustomSetting = (props: Props) => {
  ...
  const renderCommonSetting = () => {
    return (
      <SettingSection>
        <SettingRow className='mb-4' tag='label' label={nls('overrideCommonSettings')}>
          <Switch
