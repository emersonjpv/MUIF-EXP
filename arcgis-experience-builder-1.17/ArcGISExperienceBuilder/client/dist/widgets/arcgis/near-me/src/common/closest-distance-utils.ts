 ...
 */
export const getDistance = (selectedGeometry: __esri.geometryGeometry, intersectedGeometry: __esri.geometryGeometry, distanceUnit: __esri.LinearUnits): string | number => {
  ...
  (intersectedGeometry && webMercatorUtils.canProject(intersectedGeometry, geodesicSR))) {
    ...
    selectedGeometry = webMercatorUtils.project(selectedGeometry, geodesicSR) as __esri.geometryGeometry
    intersectedGeometry = webMercatorUtils.project(intersectedGeometry, geodesicSR) as __esri.geometryGeometry
...
const getGeodesicDistancebetweenMultipointToPoint = (multiPointGeom: __esri.geometryGeometry, point: __esri.Geometry): number => {
