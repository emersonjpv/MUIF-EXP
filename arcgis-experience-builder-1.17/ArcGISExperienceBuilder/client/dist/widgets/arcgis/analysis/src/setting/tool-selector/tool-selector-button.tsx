  ...
  return (
    <Button
      ...
      <div className='w-100 d-flex align-items-center inner-box'>
        ...
        {disabled && !!disabledWarningText && <Tooltip placement='bottom' showArrow interactive leaveDelay={500} title={disabledWarningText} css={css`width: 230px; padding: 8px 10px 6px 8px;`}>
