...
export const SelectParameterPopper = (props: Props) => {
  ...
  hooks.useUpdateEffect(() => {
    ...
    if (selectedTool.type === ToolType.Standard) {
      ...
      const toolJsonPath = `${widgetUrl}dist/analysis-assets/arcgis-analysis-assets/assets/tool-json/${lowercaseToolName}.tool.json`
      const toolUIJsonPath = `${widgetUrl}dist/analysis-assets/arcgis-analysis-assets/assets/tool-ui-json/${lowercaseToolName}.tool.ui.json`
      const t9nPath = `${widgetUrl}dist/analysis-assets/arcgis-analysis-assets/assets/t9n/${lowercaseToolName}/${lowercaseToolName}.t9n.${locale}.json`
      Promise.all([
