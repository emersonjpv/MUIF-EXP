...
import { defineCustomElements as defineAnalysisComponentsCustomElements } from '@arcgis/analysis-components/dist/loader'
import { defineCustomElements as defineAnalysisToolCustomElements } from '@arcgis/analysis-tool-app/dist/loader'

import { defineCustomElements } from '@arcgis/app-components/dist/loader'

import { defineCustomElements as mapConfigComponentsDefineCustomElements } from '@arcgis/map-config-components/dist/loader'

import { defineCustomElements as commonComponentsDefineCustomElements } from '@arcgis/common-components/dist/loader'
...
const Widget = (props: Props) => {
  ...
  useEffect(() => {
    ...
    defineAnalysisToolCustomElements(window, { resourcesUrl: getAnalysisAssetPath() })
    defineAnalysisComponentsCustomElements(window, { resourcesUrl: getAnalysisAssetPath() })
