  ...
  return (
    <div className='map-layers-header d-flex justify-content-between p-1' css={getStyle(theme)}>
      ...
      <div className='map-layers-header-icons d-flex'>
        ...
        {
          enableSearch &&
          <Tooltip role='tooltip' title={translate("SearchLabel")} enterDelay={1000} enterNextDelay={1000} placement='top'>
            <Button variant='text' className='map-layers-search-btn' icon onClick={onSearchBtnClick} aria-label={translate("SearchLabel")}>
