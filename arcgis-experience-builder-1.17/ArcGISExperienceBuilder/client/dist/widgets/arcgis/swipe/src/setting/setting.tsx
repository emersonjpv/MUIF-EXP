...
const Setting = (props: AllWidgetSettingProps<IMConfig>) => {
  ...
  const { defaultActivation = false, detailsVisibility = true, isAllowDeactivateLayers = true, toggleLayerVisibility = false, sliderPosition = DEFAULT_SLIDER_POSITION, dividerColor = 'var(--ref-palette-neutral-200)', handleColor = 'var(--ref-palette-neutral-200)' } = styleConfig || {}
