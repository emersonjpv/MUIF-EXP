...
export const isLayersHidden = (jimuLayerView: JimuLayerView, jimuLayerViews: JimuLayerViews): boolean => {
  return jimuLayerView.type === JSAPILayerTypes.SubtypeSublayer || isSubLayersOfMapService(jimuLayerView, jimuLayerViews)
}
...
const isMapServiceOutMost = (jimuLayerView: JimuLayerView, jimuLayerViews: JimuLayerViews) => {
  if (jimuLayerView.parentJimuLayerViewId) {
    ...
    const isMapService = jimuLayerView.type === JSAPILayerTypes.MapImageLayer || jimuLayerView.type === JSAPILayerTypes.TileLayer
    return isMapService
  }
}
