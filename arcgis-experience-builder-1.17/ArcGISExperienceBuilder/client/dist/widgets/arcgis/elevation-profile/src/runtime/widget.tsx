    ...
    return new Promise((resolve) => {
      ...
      if (this._defaultViewModel?.input) {
        ...
        if (this._selectedBufferValues.enabled && this._selectedBufferValues.bufferDistance > 0) {
          ...
          if (geometryEngine && !geometryEngine.isSimple(inputGeometry as __esri.geometryGeometry)) {
            inputGeometry = geometryEngine.simplify(inputGeometry as __esri.geometryGeometry)
          }
                  ...
                  if (intersectingPointToTheLine.length > 0) {
                    intersectingPointToTheLine.forEach((intersectingPointFeature) => {
                      if (!intersectingLineToTheLine) {
                        ...
                        const checkFeatureForProfiling = geometryEngine.intersects(intersectingPointFeature, intersectingLineToTheLine as __esri.geometryGeometry)
