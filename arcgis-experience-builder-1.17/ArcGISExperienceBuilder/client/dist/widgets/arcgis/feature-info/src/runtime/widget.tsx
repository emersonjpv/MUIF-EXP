...
import {
  ...
  type DataSource, type ArcGISQueriableDataSource, type MapDataSource, type FeatureLayerDataSource, getAppStore, appConfigUtils, type IMState, type Timezone, ReactResizeDetector, DataSourceManager
    ...
    if (this.props.config.clearSelection) {
      clearSelectionContent = (
        <div className='clear-selection d-flex justify-content-center align-items-center'>
          <Button title={title} type='tertiary' size='sm' icon onClick={this.onClearSelectionBtnClick} aria-label={title}>
