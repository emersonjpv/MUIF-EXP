/** @jsx jsx */
import { React, jsx, css, type AllWidgetProps, DataSourceManager, DataSourceStatus, type FeatureLayerDataSource, type UseUtility, UtilityManager, getAppStore, hooks, MutableStoreManager, ReactRedux, type IMState, ServiceManager, type ResourceSessions, dataSourceUtils } from 'jimu-core'
...
import type { IMConfig, IMSearchConfig } from '../config'
import { DefaultJSAPISearchProperties } from '../constants'
import { getDirectionPointOutputDsId, getDirectionLineOutputDsId, getRouteOutputDsId, getStopOutputDsId, getDefaultOrgUnit } from '../utils'
...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  }, [id, jimuMapView?.view, searchConfig, routeConfig?.useUtility, defaultSearchHint, isReadyToRender, isDarkTheme, props.autoHeight, updateFromDataAction, utilitiesChangedFlag, props.label, translate, config?.showRuntimeLayers, config?.unit])
