...
export function ExpandedItems (props: { widgetId: string, tooltip: string }) {
  ...
  return (
    isSingleMode
      ...
      : <MultiSelect aria-label={tooltip} size='sm' css={css`.jimu-dropdown { width: 100%; }`} placeholder={translate('none')} values={values} items={allOptions} onClickItem={handleValuesChange} />
  )
}
