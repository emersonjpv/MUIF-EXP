exports.getCommon = function (commonOptions = {}) {
  ...
  const jsApiUrl = process.env.ARCGIS_JSAPI_URL || 'https://js.arcgis.com/4.32/';
  const calciteComponentsUrl = 'https://js.arcgis.com/calcite-components/3.0.3/';
  ...
  function isRequestExternal(request){
    ...
    const fullMatchPackages = [
      ...
      'jimu-ui/advanced/map', 'jimu-ui/advanced/chart', 'jimu-ui/advanced/coordinate-control', 'jimu-ui/advanced/builder-components',

      'arcgis-charts-components', 'calcite-components', 'jimu-ui/advanced/chart-engine', 'arcgis-map-components', 'arcgis-coding-components',
